                                    ...
                                    <table class="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <a alt="{{ __('Edit') }}" href="{{ route('app.blog.post.edit', $post->id) }}" class="bg-gray-100 hover:bg-blue-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                                                ...
                                                <a alt="{{ __('Delete') }}" href="{{ route('app.blog.post.destroy', $post->id) }}" class="bg-gray-100 hover:bg-red-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="h-5 w-5 inline-block align-middle">
