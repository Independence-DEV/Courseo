    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-input id="email" class="block mt-1 w-full" type="email" name="email" :value="isset($email) ? $email : old('name')" required />
            </div>
            ...
            <div class="mt-4">
                ...
                <div class="mt-4">
                    <x-label for="account_name" :value="__('Website Name')" />

                    <x-input id="account_name" class="block mt-1 w-full" type="text" name="account_name" required />
                </div>
