...
<div class="cell example example1" id="example-1">
    <form action="{{ route('account.memberarea.course.processpayment', ['account_subdomain' => $account->subdomain, 'courseSlug' => $course->slug, 'prospectId' => $prospect->id]) }}" method="POST">
        @csrf
        <fieldset>
            <div class="row">
                <label for="example1-name" data-tid="elements_examples.form.name_label">Name</label>
                <input id="example1-name" data-tid="elements_examples.form.name_placeholder" type="text" value="{{ $prospect->name }}" autocomplete="name">
            </div>
            <div class="row">
                <label for="example1-email" data-tid="elements_examples.form.email_label">Email</label>
                <input id="example1-email" data-tid="elements_examples.form.email_placeholder" type="email" value="{{ $prospect->email }}" autocomplete="email">
            </div>
        </fieldset>
        <fieldset>
            <div class="row">
        ...
        <button type="submit" >{{ __('Pay') }} {{ $course->price }}€</button>
